export default function GallerySection() {
  const galleryItems = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=600&h=400",
      span: "col-span-1"
    }
  ];
    ...
    <section id="gallery" className="py-20 bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">Behind the <span className="electric-violet">Scenes</span></h2>
          <p className="text-xl text-gray-300">Professional studio shots and work environment</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {galleryItems.map((item) => (
            <div key={item.id} className={`${item.span} relative overflow-hidden rounded-xl group`}>
              <img
                src={item.image}
                alt={item.title}
